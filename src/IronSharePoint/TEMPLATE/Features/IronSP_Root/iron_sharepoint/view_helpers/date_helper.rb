...
module IronSharePoint
  module ViewHelpers
    ...
    class DateTimeSelector #:nodoc:
      ...
      include IronSharePoint::ViewHelpers::TagHelper
      ...
      private
        ...
        def input_name_from_type(type)
          prefix = @options[:prefix] || IronSharePoint::ViewHelpers::DateTimeSelector::DEFAULT_PREFIX
          prefix += "[#{@options[:index]}]" if @options.has_key?(:index)

          field_name = @options[:field_name] || type
          if @options[:include_position]
            field_name += "(#{IronSharePoint::ViewHelpers::DateTimeSelector::POSITION[type]}i)"
          end
