...
processors in ruby easier than ever!}
  ...
  s.files = [".autotest", "History.txt", "Manifest.txt", "README.txt", "Rakefile", "bin/r2r_show", "lib/ruby2ruby.rb", "test/test_ruby2ruby.rb", ".gemtest"]
  s.homepage = %q{https://github.com/seattlerb/ruby2ruby}
